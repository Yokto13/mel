...
DAMUEL_DESCS_TOKENS_RAW="$OUTPUTS/v2_normal_filtered/descs_pages"
DAMUEL_LINKS_TOKENS_RAW="$OUTPUTS/v2_normal_filtered/links"
MEWSLI_TOKENS_RAW="$OUTPUTS/tokens_mewsli_finetuning"
WORKDIR="$OUTPUTS/workdirs/asi_se_to_rozbilo_init_all"
N_OF_ROUNDS=6
...
run_ml_finetuning_round() {
    ...
    ../venv/bin/python $ACTION_SCRIPT "evaluate" \
        --root_dir="$WORKDIR" \

...
def test_embed_links_for_generation():
    ...
    with (
        ...
        patch("finetunings.generate_epochs.embed_links_for_generation._save") as mock_save,
    ):
        ...
        mock_embed_generator.assert_called_once_with(mock_dataset, mock_model, batch_size)

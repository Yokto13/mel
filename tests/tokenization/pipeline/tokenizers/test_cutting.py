...
class TestCuttingTokenizer:
    def test_context_tokenizer_output_format(self, mocker):
        ...
        tokens_cutter_mock = mocker.patch("tokenization.pipeline.tokenizers.cutting.TokensCutter")
        tokens_cutter_mock.return_value.cut_mention_with_context.return_value = np.array([1, 2, 3])
        ...
        tokenizer = CuttingTokenizer(tokenizer_mock, expected_size=64, label_token="[M]")
